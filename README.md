...
- [`C9.Simple-Linear-Regression-CO2Emission.ipynb`](C9.Simple-Linear-Regression-CO2Emission.ipynb): a lab on using skit-learn to implement a simple Linear Regression model
