...
- [`C6W2.Data-Wrangling-automobile_dataset.ipynb`](C6.Data-Wrangling-automobile_dataset.ipynb): Data Wrangling on the [Automobile Dataset](https://www.kaggle.com/datasets/toramky/automobile-dataset) 
- [`C6W3.Exploratory-Data-Analysis.ipynb`](C6W3.Exploratory-Data-Analysis.ipynb): Exploratory Data Analysis on the Automobile Dataset, uncover relationships between variables and extract features with the most impact
