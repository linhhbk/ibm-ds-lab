...
- [`C8W1.Introduction-to-Matplotlib-LinePlots.ipynb`](C8W1.Introduction-to-Matplotlib-and-LinePlots.ipynb): Line Plots using [Matplotlib](https://matplotlib.org/stable/gallery/index) on the Immigration to Canada (1980-2013) dataset 
...
- [`C8W2B.PieCharts-Box-Scatter-BubblePlots.ipynb`](C8W2B.Exercise-PieCharts-BoxPlots-ScatterPlots-and-BubblePlots.ipynb): Pie Charts, Box Plots, Scatter Plots, and Bubble Plots using [Matplotlib](https://matplotlib.org/stable/gallery/index)
